...
public final class BlurhashModelLoader implements com.bumptech.glide.load.model.ModelLoader<expo.modules.image.GlideBlurhashModel, android.graphics.Bitmap> {
    ...
    expo.modules.image.GlideBlurhashModel model, int width, int height, @org.jetbrains.annotations.NotNull()
    com.bumptech.glide.load.Options options) {
        return null;
    }
    
    private final <T extends java.lang.Object>T getPath(android.net.Uri uri, int index, T p2_772401952, kotlin.jvm.functions.Function1<? super java.lang.String, ? extends T> converter) {
        return null;
    }
}